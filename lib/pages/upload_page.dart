      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => viewModel.clearAllFiles(),
    ...
    switch (viewModel.state) {
      ...
      case UploadPageState.filesSelected:
        return ElevatedButton.icon(
          ...
          label: const Text('上傳並生成總結', style: TextStyle(fontSize: 16)),
          style: ElevatedButton.styleFrom(padding: const EdgeInsets.symmetric(vertical: 16)),
        );
      case UploadPageState.uploading:
        return ElevatedButton(
      ...
      case UploadPageState.success:
        return ElevatedButton(
          ...
          child: Text('上傳成功', style: TextStyle(fontSize: 16)),
        );
    }
  }
